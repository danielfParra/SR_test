...
class Constants(BaseConstants):
    ...
    O_payoff_PB = ['By guessing the secret number as accurately as possible',
                   'By guessing a number that is as close as possible to the message', 'By always guessing low',
                   'By always guessing high']
    ...
    O_payoff_PA = ['By making Player B guess the secret number', 'By making Player B guess as high as possible',
                   'By making Player B guess close to the sent number']
    ...
    O_payoff_other_PA = ['By guessing the secret number as accurately as possible',
                         'By guessing a number that is as close as possible to the message', 'By always guessing low',
                         'By always guessing high']
    ...
    O_payoff_other_PB = ['By making you guess the secret number', 'By making you guess as high as possible',
                         'By making you guess close to the sent number']
    ...
    O_independence = ['It is likely that it is larger than 5, since the secret number was 5 in the previous rounds',
                      'It is likely that it is smaller than 5, since the secret number was 5 in the previous rounds',
                      'It is likely that it is 5, since the secret number was 5 in the previous rounds',
                      'Any number is equally likely, regardless of the previous rounds']
    ...
    O_secret_number_generation = ['It is chosen by Player A', 'It is chosen by Player B',
                                  'It is randomly generated by the computer']
    ...
    O_no_knowledge_guess = ['Guessing a random number', 'Guessing 7 (the highest number)',
                            'Guessing 1 (the lowest number)', 'Guessing 4 (the average of all possible numbers)']
